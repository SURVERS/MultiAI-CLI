...
// Run: pnpm --filter @multiai/web exec vitest run test/workspace-state.test.ts
...
import type { ExtendedState } from '../src/composables/useMultiAIWebClient';
