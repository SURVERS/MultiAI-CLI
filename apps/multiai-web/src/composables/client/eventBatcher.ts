// apps/multiai-web/src/composables/client/eventBatcher.ts
...
// tested directly. See useMultiAIWebClient.ts for the WS pipeline wiring.

import type { AppEvent, MultiAIEventMeta } from '../../api/types';
