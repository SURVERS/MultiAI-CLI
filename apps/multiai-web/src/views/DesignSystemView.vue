  ...
  <div class="ds-page">
    ...
    <div class="layout">
      ...
      <aside class="sidebar">
        <div class="brand">
          ...
          <div class="brand-name">MultiAI Web</div>
        </div>
        ...
        <div class="content-inner">
          ...
          <section id="overview">
            <div class="hero">
              ...
              <h1>MultiAI Web <span class="grad">Design System</span></h1>
              <p class="lead">
                This document defines the visual language and component specification for MultiAI Web — design tokens, component primitives, the chat interface, theming, and style rules.
                All UI work is grounded in it: unified, restrained, token-driven, and themeable.
              </p>
              <div class="hero-meta">
                <span class="meta-chip"><span class="dot"></span> Scope <b>apps/multiai-web</b></span>
          ...
          <section id="principles">
            ...
            <p class="sec-desc">
              Every UI decision traces back to the following principles. MultiAI Web is a local Agent tool for developers: quick scanning, long stretches of staring, often in the dark — the design serves the task, and is restrained, clinical, and density-first.
            </p>
          ...
          <section id="tokens">
            ...
            <p>MultiAI Web uses two font families: <b>--font-ui</b> (UI and body, Inter first) and <b>--font-mono</b> (code and monospace). Components always reference the variables; do not hard-code font names.</p>
      ...
      ui-monospace, "SF Mono", Menlo, Consolas, monospace;</pre></div>
            ...
            <p>Do not use emoji as functional icons. The MultiAI brand mark is a brand asset and is not part of this icon system.</p>
    ...
    export function auth(token: string) {
      return verify(token, process.env.JWT_SECRET!);
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col">
                <div class="p-empty" style="width:100%;border:1px dashed var(--p-line);border-radius:var(--p-r-lg)">
                  ...
                  <div class="em-hint">Click "New chat" to start a conversation with MultiAI</div>
                </div>
              </div>
            </div>
          ...
          <section id="chat">
            ...
            <p class="sec-desc">
              The message stream is the core of MultiAI Web. The goal of the overhaul: have the 6 card types (Agent / Tool / Question / Approval / Swarm / Todo)
            ...
            <div class="stage-wrap">
              ...
              <div class="stage p col" style="align-items:center;background:#fff">
                <div class="p-composer" style="width:100%;max-width:620px">
                  <div class="p-composer-ta ph">Message MultiAI, / to run a command, @ to reference a file…</div>
          ...
          <section id="themes">
            ...
            <p class="sec-desc">
              MultiAI Web uses <b>one unified theme</b>: the same components, fonts, radii, shadows, and surfaces — "reskinning" only changes colors.
          ...
          <section id="rules">
            ...
            <div class="callout good"><span class="ico">✓</span><div>
              The waiting animation is <b>used only in the chat state of "message sent, waiting for the Agent's first response"</b> and is rendered uniformly by the <code>MoonSpinner</code> component; waiting states such as <code>ActivityNotice</code> reuse it rather than implementing their own animation.
            ...
            <div class="footer">
              <span>MultiAI Web Design System · v1.0</span>
    ...
    /*         sidebar ↑    ↑handle  ↑conversation  ↑handle ↑right panel (auto) */</pre></div>
          ...
          <section id="a11y">
            ...
            <p class="sec-desc">
              MultiAI Web is a local developer tool; it <b>does not target a specific WCAG conformance level</b>, nor maintain a full screen-reader QA matrix.
