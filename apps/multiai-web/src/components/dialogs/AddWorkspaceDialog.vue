<!-- apps/multiai-web/src/components/dialogs/AddWorkspaceDialog.vue -->
<!-- Daemon-driven folder browser for adding a workspace: starts at the path -->
<!-- multiai-web is working in, with a clickable breadcrumb and the folder list -->
...
const props = defineProps<{
  ...
  /** Where the browser opens by default — the path multiai-web is working in. */
  defaultPath?: string;
...
onMounted(async () => {
  ...
  try {
    ...
    // Default to the path multiai-web is working in; fall back to $HOME.
