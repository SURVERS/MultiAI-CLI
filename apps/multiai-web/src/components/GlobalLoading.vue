<!-- apps/multiai-web/src/components/GlobalLoading.vue -->
<!-- Full-screen splash shown on first load until the client has talked to the
     ...
     app. Hidden once useMultiAIWebClient.initialized flips true. -->
...
<template>
  <div class="gload" role="status" :aria-label="t('app.connecting')">
    <div class="gload-box">
      <img class="gload-logo" src="/assets/multiai-logo-dark.png" alt="" aria-hidden="true" />
