      ...
      <div class="ch">
        <div class="ch-brand">
          <template v-if="!isMacosDesktop">
            <img ref="logoRef" class="ch-logo" :class="{ 'is-dev': isDev }" src="/favicon.svg" alt="MultiAI CLI" @click="onLogoClick" @pointerdown="onLogoPointerDown" @pointerup="onLogoPointerUp" @pointercancel="onLogoPointerUp" />
