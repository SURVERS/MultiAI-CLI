...
declare const __MULTIAI_DEV_PROXY_TARGET__: string;
...
// GET /__multiai-dev/backend; this is the synchronous initial value. Unused by
// the same-origin production build.
declare const __MULTIAI_DEV_BACKENDS__: { default: string; multi: string };

// Injected by Vite `define` from apps/multiai-web/package.json.
declare const __MULTIAI_WEB_VERSION__: string;

// Injected by Vite `define`: true only in a MultiAI desktop bundle.
declare const __MULTIAI_WEB_DESKTOP__: boolean;
