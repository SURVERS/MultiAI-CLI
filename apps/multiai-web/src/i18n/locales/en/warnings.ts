export default {
  ...
  daemonApiTitle: 'MultiAI daemon returned an error',
  daemonNetworkMessage: 'Web did not receive a response from the local service. Check that the MultiAI daemon is still running, or refresh the page.',
  daemonNetworkTitle: 'Cannot connect to MultiAI daemon',
  diagnostics: 'Diagnostics',
  hideDetails: 'Hide details',
  operationFailedMessage: 'The last operation did not finish. Try again later.',
  operationFailedTitle: 'Operation failed',
  sessionSnapshotMessage: 'Web could not load the current conversation. Check that the MultiAI daemon is still running, or refresh the page.',
