// apps/multiai-web/src/lib/icons.ts
// Single source of truth for apps/multiai-web icons (design-system §02).
//
...
//   - `~icons/multiai/*` — MultiAI design system icons (24×24 outlined,
//     fill="currentColor"), local SVGs under src/icons/multiai/ registered as a
//     custom collection in vite.config.ts. Preferred when a MultiAI icon exists
//     for the intent.
...
// Components (MultiAI collection) -------------------------------------------
import MultiAIAddConversation from '~icons/multiai/add-conversation';
import MultiAIFolder from '~icons/multiai/folder';
import MultiAIFolderOpen from '~icons/multiai/folder-open';
import MultiAIMore from '~icons/multiai/more';
import MultiAISearch from '~icons/multiai/search';
import MultiAISetting from '~icons/multiai/setting';
...
// Raw SVG strings (MultiAI collection) --------------------------------------
import RawMultiAIAddConversation from '~icons/multiai/add-conversation?raw';
import RawMultiAIFolder from '~icons/multiai/folder?raw';
import RawMultiAIFolderOpen from '~icons/multiai/folder-open?raw';
import RawMultiAIMore from '~icons/multiai/more?raw';
import RawMultiAISearch from '~icons/multiai/search?raw';
import RawMultiAISetting from '~icons/multiai/setting?raw';
...
export const ICONS: Record<IconName, IconEntry> = {
  ...
  'chat-new': entry(MultiAIAddConversation, RawMultiAIAddConversation),
  ...
  search: entry(MultiAISearch, RawMultiAISearch),
  ...
  settings: entry(MultiAISetting, RawMultiAISetting),
  ...
  folder: entry(MultiAIFolderOpen, RawMultiAIFolderOpen),
  'folder-closed': entry(MultiAIFolder, RawMultiAIFolder),
  ...
  'dots-horizontal': entry(MultiAIMore, RawMultiAIMore),
};
