// apps/multiai-web/src/lib/storage.ts
...
export const STORAGE_KEYS = {
  // useMultiAIWebClient
  permission: 'multiai-web.permission',
  activeWorkspace: 'multiai-active-workspace',
  planMode: 'multiai-web.plan-mode',
  swarmMode: 'multiai-web.swarm-mode',
  goalMode: 'multiai-web.goal-mode',
  uiFontSize: 'multiai-web.ui-font-size',
  starredModels: 'multiai-web.starred-models',
  unread: 'multiai-web.unread',
  onboarded: 'multiai-web.onboarded',
  accent: 'multiai-web.accent',
  colorScheme: 'multiai-web.color-scheme',
  hiddenWorkspaces: 'multiai-web.hidden-workspaces',
  collapsedWorkspaces: 'multiai-web.collapsed-workspaces',
  workspaceOrder: 'multiai-web.workspace-order',
  workspaceNameOverrides: 'multiai-web.workspace-name-overrides',
  workspaceSort: 'multiai-web.workspace-sort',
  ...
  conversationToc: 'multiai-web.beta-toc',
  notifyOnComplete: 'multiai-web.notify-on-complete',
  notifyOnQuestion: 'multiai-web.notify-on-question',
  notifyOnApproval: 'multiai-web.notify-on-approval',
  soundOnComplete: 'multiai-web.sound-on-complete',
  inputHistory: 'multiai-web.input-history',
  // cross-file
  locale: 'multiai-locale',
  clientId: 'multiai-web.client-id',
  debug: 'multiai-web.debug',
  openInLastTarget: 'multiai-web.open-in.last-target',
  sidebarCollapsed: 'multiai-web.sidebar-collapsed',
  sidebarWidth: 'multiai-web.sidebar-width',
  // deprecated cleanups (kept so the removals still fire for old users)
  codeFont: 'multiai-web.code-font',
  contentAlign: 'multiai-web.content-align',
  theme: 'multiai-web.theme',
  thinking: 'multiai-web.thinking',
} as const;

/** Per-session composer draft key. */
export function draftStorageKey(sid: string | undefined): string {
  return `multiai-web.draft.${sid && sid.length > 0 ? sid : '__new__'}`;
}
