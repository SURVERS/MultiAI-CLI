// apps/multiai-web/src/api/daemon/http.ts
...
export class DaemonHttpClient {
  ...
  private addClientHeaders(headers: Record<string, string>): void {
    ...
    headers['X-MultiAI-Client-Id'] = this.identity.clientId;
    headers['X-MultiAI-Client-Name'] = this.identity.clientName;
    headers['X-MultiAI-Client-Version'] = this.identity.clientVersion;
    headers['X-MultiAI-Client-Ui-Mode'] = this.identity.clientUiMode;
  }
