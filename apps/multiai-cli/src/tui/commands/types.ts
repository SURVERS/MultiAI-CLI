import type { AutocompleteItem, SlashCommand } from '@multiai/pi-tui';
import type { FlagId } from '@multiai/sdk';

export type SlashCommandAvailability = 'always' | 'idle-only';

export interface MultiAISlashCommand<Name extends string = string> extends SlashCommand {
  readonly name: Name;
