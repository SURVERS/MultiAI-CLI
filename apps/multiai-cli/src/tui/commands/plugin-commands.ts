import type { PluginCommandDef } from '@multiai/sdk';

import type { MultiAISlashCommand } from './types';

export interface PluginSlashCommands {
  readonly commands: readonly MultiAISlashCommand[];
