...
export const WORKING_TIPS: readonly ToolbarTip[] = [
  ...
  { text: '/plugins: manage local plugins and explicitly configured marketplaces', solo: true },
  { text: 'ask MultiAI to schedule tasks, e.g. "remind me at 5pm"', solo: true, priority: 3 },
...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: '/auto when you want MultiAI to handle approvals and keep going unattended' },
  ...
  { text: 'shift-tab to Plan mode to review the approach before MultiAI edits files.', priority: 2 },
