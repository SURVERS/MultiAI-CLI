/**
 * Shared helpers for `multiai web` and its subcommands.
 *
...
import type { ServerLogLevel } from '@multiai/kap-server';
...
/** Filename (under MULTIAI_HOME) of the persistent server bearer token. */
 ...
 * is the CLI's own MULTIAI_HOME resolution (`getDataDir()`).
 *
