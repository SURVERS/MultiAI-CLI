...
function makeDriver(): { driver: SignalDriver; tui: MultiAITUI } {
  const tui = new MultiAITUI(makeHarness() as never, makeStartupInput());
...
describe('MultiAITUI signal handlers', () => {
