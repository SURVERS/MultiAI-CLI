/**
 * Scenario: describing the native bundle manifest.
 * Responsibilities: expose stable versions, keys, and target support checks.
 * Wiring: manifest helpers are exercised as pure functions.
 * Run: pnpm --filter @multiai/cli exec vitest run test/scripts/native/manifest.test.ts
 */
