 ...
 */
export class MultiAIWebviewProvider implements vscode.WebviewViewProvider {
  ...
  createPanel(): vscode.WebviewPanel {
    ...
    const panel = vscode.window.createWebviewPanel("multiaiPanel", "MultiAI CLI", vscode.ViewColumn.One, {
      enableScripts: true,
