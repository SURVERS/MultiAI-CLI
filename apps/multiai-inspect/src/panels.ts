...
import { IAuthSummaryService } from '@multiai/agent-core-v2/app/auth/auth';
...
import { ISessionInitService } from '@multiai/agent-core-v2/session/sessionInit/sessionInit';
...
import { ISessionWorkspaceContext } from '@multiai/agent-core-v2/session/workspaceContext/workspaceContext';
import { IAgentActivityView } from '@multiai/agent-core-v2/agent/activityView/activityView';
import { IAgentContextSizeService } from '@multiai/agent-core-v2/agent/contextSize/contextSize';
import { IAgentGoalService } from '@multiai/agent-core-v2/agent/goal/goal';
import { IAgentMcpService } from '@multiai/agent-core-v2/agent/mcp/mcp';
import { IAgentPermissionModeService } from '@multiai/agent-core-v2/agent/permissionMode/permissionMode';
import { IAgentPermissionRulesService } from '@multiai/agent-core-v2/agent/permissionRules/permissionRules';
...
import { IAgentSwarmService } from '@multiai/agent-core-v2/agent/swarm/swarm';
import { IAgentTaskService } from '@multiai/agent-core-v2/agent/task/task';
import { IAgentToolRegistryService } from '@multiai/agent-core-v2/agent/toolRegistry/toolRegistry';
