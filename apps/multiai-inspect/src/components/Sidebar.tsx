...
import { ISessionIndex, type SessionSummary } from '@multiai/agent-core-v2/app/sessionIndex/sessionIndex';
import { ISessionLifecycleService } from '@multiai/agent-core-v2/app/sessionLifecycle/sessionLifecycle';
import { IWorkspaceService, type Workspace } from '@multiai/agent-core-v2/app/workspace/workspace';
