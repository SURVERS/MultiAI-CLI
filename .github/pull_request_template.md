<!--
Thank you for your contribution to MultiAI CLI!
Please open an issue before sending a feature PR — PRs without prior discussion may be closed without review.

See https://github.com/SURVERS/MultiAI-CLI/blob/main/CONTRIBUTING.md for more.
-->
...
<!-- What did you implement, and why does this approach fit MultiAI CLI? -->

## Checklist

- [ ] I have read the [CONTRIBUTING](https://github.com/SURVERS/MultiAI-CLI/blob/main/CONTRIBUTING.md) document.
