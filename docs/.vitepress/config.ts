...
const config = withMermaid(defineConfig({
  ...
  locales: {
    zh: {
      ...
      lang: 'zh-CN',
      link: '/zh/',
      title: 'MultiAI CLI 文档',
      description: 'MultiAI CLI 用户文档',
      themeConfig: {
        nav: [
          ...
          { text: '参考手册', link: '/zh/reference/multiai-command', activeMatch: '/zh/reference/' },
          ...
          '/zh/guides/': [
            {
              ...
              items: [
                ...
                { text: 'OAuth 与账户', link: '/zh/guides/account-and-oauth' },
                { text: '旧版本数据', link: '/zh/guides/migration' },
          ...
          '/zh/reference/': [
            {
              text: '参考手册',
              items: [
                { text: 'multiai 命令', link: '/zh/reference/multiai-command' },
                { text: 'multiai acp 子命令', link: '/zh/reference/multiai-acp' },
