/**
 * `@multiai/server-e2e` — wire-level test client for the kimi-code server.
 *
 ...
 *
 * Re-exports `@multiai/protocol` types are NOT bundled here — scenarios
 * that want them import from `@multiai/protocol` directly.
 */
