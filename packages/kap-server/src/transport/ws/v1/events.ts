...
import type { DomainEvent } from '@multiai/agent-core-v2/app/event/eventBus';
import type { MessageContent } from '@multiai/agent-core-v2/agent/contextMemory/protocolMessage';
