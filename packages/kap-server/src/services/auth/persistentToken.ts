 ...
 *
 * The token lives at `<MULTIAI_HOME>/server.token` (mode 0600) and is reused
 ...
 * `multiai web rotate-token` (which calls {@link rotateServerToken}).
 *
...
/** On-disk filename for the persistent token, relative to MULTIAI_HOME. */
