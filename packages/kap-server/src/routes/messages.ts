...
import { IMessageLegacyService, isError2, type Scope } from '@multiai/agent-core-v2';
import { messageRoleSchema } from '@multiai/agent-core-v2/agent/contextMemory/protocolMessage';
