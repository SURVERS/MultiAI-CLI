...
async function main(): Promise<void> {
  const homeDir = await mkdtemp(join(tmpdir(), 'multiai-harness-rename-home-'));
  const workDir = await mkdtemp(join(tmpdir(), 'multiai-harness-rename-work-'));
