...
import { createMultiAIHarness, ImageLimits, MultiAIHarness, SDKRpcClientBase } from '#/index';
...
/**
 * The recursive RPC surface MultiAIHarness touches for the tests below: kept
...
describe('MultiAIHarness imageLimits', () => {
...
`,
  ...
  it('a hand-built harness returns the injected ImageLimits as-is', () => {
    ...
    const harness = new MultiAIHarness(new StubRpc(), {
      homeDir: '/tmp/home',
