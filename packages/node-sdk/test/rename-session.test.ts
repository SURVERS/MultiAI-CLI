...
import { createMultiAIHarness, MultiAIError, type Event } from '#/index';
...
describe('MultiAIHarness.renameSession', () => {
  ...
  it('rejects missing session ids', async () => {
    ...
    try {
      ...
      await expect(missingRename).rejects.toBeInstanceOf(MultiAIError);
