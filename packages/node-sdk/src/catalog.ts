import type { MultiAIConfig, ModelAlias } from '@multiai/agent-core';
import {
  catalogBaseUrl,
 ...
 * `userAgent` identifies the host product (e.g. `multiai-cli/1.2.3`); when
...
/** Builds a MultiAI model alias from a normalized catalog model. */
 ...
 * `__MULTIAI_BUILT_IN_CATALOG__` constant injected by tsdown at build
