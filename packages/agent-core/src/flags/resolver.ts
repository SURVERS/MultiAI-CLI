...
export const MASTER_ENV = 'MULTIAI_EXPERIMENTAL_FLAG';
 ...
 *   L1 master switch MULTIAI_EXPERIMENTAL_FLAG → every flag is on
 ...
 * Runtime code that belongs to a MultiAICore/Session/Agent should use the scoped
