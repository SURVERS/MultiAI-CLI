 ...
 *
 * **Anti-corruption**: imports `@multiai/agent-core` only for the
 * `createDecorator` value.
 */

import { createDecorator } from '../../di';
import type { ToolDescriptor, ToolSource } from '@multiai/protocol';
 ...
 * `@multiai/agent-core` `ToolInfo` without taking a runtime dependency on
