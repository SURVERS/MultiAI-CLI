import type { MultiAIConfig } from './schema';

/**
 * Print-mode (`multiai -p`) defaults for the v1 engine. A headless run should not
 ...
 */
export function applyPrintModeConfigDefaults(config: MultiAIConfig): MultiAIConfig {
  return {
    ...config,
