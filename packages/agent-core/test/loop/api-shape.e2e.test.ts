...
import type { ContentPart, ModelCapability, TokenUsage } from '@multiai/kosong';
...
function _typeOnlyChecks(): void {
  ...
  void _badStop1;
  // @ts-expect-error - max_steps is represented by a thrown MultiAIError, not StopReason.
