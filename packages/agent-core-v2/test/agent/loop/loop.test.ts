/**
 * Scenario: driving agent loop turns across success, filtering, retry, and failure paths.
 * Responsibilities: preserve turn lifecycle, context facts, tool snapshots, and terminal outcomes.
 * Wiring: a real scoped loop uses deterministic model and tool boundaries.
 * Run: pnpm exec vitest run packages/agent-core-v2/test/agent/loop/loop.test.ts
 */
...
describe('Agent loop', () => {
  ...
  it('fails the turn after a filtered step completes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] llm.request                 { "kind": "loop", "provider": "openai", "model": "mock-model", "modelAlias": "mock-model", "thinkingEffort": "off", "maxTokens": 1000000, "toolSelect": false, "systemPromptHash": "ec9c34379c88babbc468ef2f3e0e08cd2f422c8c4a910664fb8bb394d703a575", "toolsHash": "a32e35afd0f9b6db655f4214e4bf82c6aeba24bb1b8f8c8bd4c001824f03195c", "messageCount": 1, "turnStep": "0.1", "time": "<time>" }
