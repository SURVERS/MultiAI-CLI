...
- [`f4407c6`](https://github.com/SURVERS/MultiAI-CLI/commit/f4407c645add04f1f27bd55110043a91265bffb2) Thanks [@SURVERS](https://github.com/SURVERS)! - Let embedding hosts customize the agent's product name and reply-style guidance in the system prompt when starting the server.

- [`f4407c6`](https://github.com/SURVERS/MultiAI-CLI/commit/f4407c645add04f1f27bd55110043a91265bffb2) Thanks [@SURVERS](https://github.com/SURVERS)! - Count validation-rejected tool calls toward the repeat breaker so reminders fire at 3/5/8 and the turn force-stops at 12.
