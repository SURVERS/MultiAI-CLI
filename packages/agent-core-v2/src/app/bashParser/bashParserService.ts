 ...
 *
 * Thin adapter over the pure `@multiai/tree-sitter-bash` package: runs
...
import { parse } from '@multiai/tree-sitter-bash';
import type { SyntaxNode } from '@multiai/tree-sitter-bash';
