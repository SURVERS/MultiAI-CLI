 ...
 * enable via `MULTIAI_EXPERIMENTAL_SECONDARY_MODEL`, the master
 * `MULTIAI_EXPERIMENTAL_FLAG`, or the `[experimental]` config section.
...
export const SECONDARY_MODEL_FLAG_ENV = 'MULTIAI_EXPERIMENTAL_SECONDARY_MODEL';
