...
- `src/_base/errors/serialize.ts`: `ErrorPayload`, `isCodedError`, `toErrorPayload`, `fromErrorPayload`. Wire-facing names (`MultiAIErrorPayload`, `toMultiAIErrorPayload`) mirror the protocol and are kept as-is.
